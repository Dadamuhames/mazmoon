...
urlpatterns = [
    ...
    path('services', user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.ServicesList.as_view()), name='services'),
    path("services/create", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.ServiceCreate.as_view()), name='services_create'),
    path("services/<int:pk>/edit", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.ServicesUpdate.as_view()), name='services_update'),
    path("delete_service_image", user_passes_test(lambda u: u.is_superuser,
         login_url='login_admin')(views.del_sev_image), name='del_serv_image'),
